...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("father","Pere",R.drawable.family_father,R.raw.family_father));
        words.add(new Word("mother","Mere",R.drawable.family_mother,R.raw.family_mother));
        words.add(new Word("son","andsi",R.drawable.family_son,R.raw.family_son));
